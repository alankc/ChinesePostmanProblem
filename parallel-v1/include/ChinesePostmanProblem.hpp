...
private:
    ...
    **/
     ...
     *  globalBestset = (0,4)(1,2)(3,5) cost = 10
     *  
     *  Iteration 5 
     *  (0,5)-(1,2)(3,4)
     *  (0,5)-(1,3)(2,4)
     ...
     *  globalBestset = (0,5)(1,2)(3,4) cost = 3
     * 
     *  reduction globalBestset from thread 1 and globalBestset from thread 2 results in
     *  globalBestset = (0,5)(1,2)(3,4)
     * 
